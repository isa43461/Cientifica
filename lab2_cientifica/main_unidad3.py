...
def main():
	...
	print("Elapsed time: %.10f seconds." % elapsed_time1)
	...
	print("El error medio es: ",errorMedioEcN)
	print("El error medio es: ",errorMedioAbsHH)
	print("El error tipico es: ",error_tipicoEc)
	print("El error tipico es: ",error_tipicoHH)
